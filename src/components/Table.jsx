...
const Table = React.memo(() => {
  ...
  return (
    <div className="font-serif px-5 pb-5">
      ...
      {/* Global Filter */}
      <div className="flex flex-wrap justify-between space-y-2 md:space-y-0 md:space-x-6 my-4">
        <input
          type="text"
          value={globalFilter}
          onChange={(e) => dispatch(setGlobalFilter(e.target.value))}
          placeholder="Search by name"
          className="placeholder:pl-3 placeholder:text-xs border rounded-md w-full md:w-auto"
        />
        ...
        <div className="flex space-x-2 w-full md:w-auto justify-center">
          <button
            ...
            className="p-2 text-xs bg-green-500 text-white rounded cursor-pointer w-full md:w-auto"
          >
            Export to Excel
          </button>
          ...
          <button
            ...
            className="p-2 text-xs bg-blue-500 text-white rounded cursor-pointer w-full md:w-auto"
          >
            Add User
          </button>
        </div>
      ...
      <div className="overflow-x-auto">
        <table className="table-auto w-full text-[10px] md:text-xs xl:text-sm">
          <thead>
      ...
      <div className="flex flex-wrap justify-center space-x-2 my-4">
        ...
        <button
          ...
          disabled={!table.getCanPreviousPage()}
          className="bg-purple-500 rounded text-sm px-2 py-1 text-white cursor-pointer"
        >
          {"Previous"}
        </button>
        <button
          ...
          className="bg-yellow-500 rounded text-sm px-2 py-1 text-gray-600 cursor-pointer"
        >
          {"Next"}
        </button>
        <button
